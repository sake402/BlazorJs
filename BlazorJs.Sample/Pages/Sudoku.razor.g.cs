                ...
                __frame1.Component<EditForm>((__component1) =>
                {
                    ...
                    __component1.ChildContent = (context) => (__frame2, __key2) =>
                    {
                        if (size == 0 || boards == null)
                        {
                            ...
                            {
                                __frame3.Text(@"Enter board size", key: __key3, sequenceNumber: 2050060379);
                            }, key: __key2, sequenceNumber: 2050060380);
                            ...
                            }, key: __key2, sequenceNumber: 2050060381);
                            ...
                            {
                                __frame3.Text(@"Continue", key: __key3, sequenceNumber: 2050060382);
                            }, key: __key2, sequenceNumber: 2050060383);
                        }
                        else
                        {
                                    ...
                                    __frame3.Element("tr", null, (__frame4, __key4) =>
                                    {
                                        for (int _x = 0; _x < size; _x++)
                                        {
                                            ...
                                            __frame4.Element("td", null, (__frame5, __key5) =>
                                            {
                                                ...
                                                }, key: __key5, sequenceNumber: 2050060384);
                                            }, key: x, sequenceNumber: 2050060385);
                                        }
                                    }, key: y, sequenceNumber: 2050060386);
                                }
                            }, key: __key2, sequenceNumber: 2050060387);
                        }
                    };
                }, key: __key1, sequenceNumber: 2050060388);
            }, sequenceNumber: 2050060389);
        }
