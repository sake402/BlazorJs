            ...
            }, (__frame1, __key1) =>
            {
                __frame1.Component<EditForm>((__component1) =>
                {
                    ...
                    __component1.ChildContent = (context) => (__frame2, __key2) =>
                    {
                        ...
                        {
                            __frame2.Markup("<h3>Enter board size</h3>", key: __key2, sequenceNumber: 1649710538);
                            ...
                            }, key: __key2, sequenceNumber: 1649710539);
                            ...
                            {
                                __frame3.Text("Continue", key: __key3, sequenceNumber: 1649710540);
                            }, key: __key2, sequenceNumber: 1649710541);
                        }
                        else
                        {
                                    ...
                                    __frame3.Element("tr", null, (__frame4, __key4) =>
                                    {
                                        for (int _x = 0; _x < size; _x++)
                                        {
                                            ...
                                            __frame4.Element("td", null, (__frame5, __key5) =>
                                            {
                                                ...
                                                }, key: __key5, sequenceNumber: 1649710542);
                                            }, key: x, sequenceNumber: 1649710543);
                                        }
                                    }, key: y, sequenceNumber: 1649710544);
                                }
                            }, key: __key2, sequenceNumber: 1649710545);
                        }
                    };
                }, key: __key1, sequenceNumber: 1649710546);
            }, sequenceNumber: 1649710547);
        }
