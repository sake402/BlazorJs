...
//{
//    internal static partial class RoutePatternFactory
//    {
...
//        {
//            ArgumentNullExceptionExtension.ThrowIfNull(pattern);
...
//        {
//            ArgumentNullExceptionExtension.ThrowIfNull(segments);
...
//                    {
//                        var message = $"CannotHaveDefaultValueSpecifiedInlineAndExplicitly({parameter.Name})";
//                        throw new InvalidOperationException(message);
//                    }

//                    if (parameter.IsOptional)
//                    {
//                        var message = "OptionalCannotHaveDefaultValue";
//                        throw new InvalidOperationException(message);
//                    }
...
//                    else
//                    {
//                        throw new InvalidOperationException("InvalidConstraintReference");
//                    }
...
//        {
//            ArgumentNullExceptionExtension.ThrowIfNull(parts);
...
//        {
//            ArgumentExceptionExtension.ThrowIfNullOrEmpty(content);
...
//        {
//            ArgumentExceptionExtension.ThrowIfNullOrEmpty(parameterName);
...
//            ArgumentNullExceptionExtension.ThrowIfNull(parameterPolicies);
...
//        {
//            ArgumentNullExceptionExtension.ThrowIfNull(constraint);
...
//        {
//            ArgumentExceptionExtension.ThrowIfNullOrEmpty(constraint);
...
//        {
//            ArgumentNullExceptionExtension.ThrowIfNull(parameterPolicy);
...
//        {
//            ArgumentExceptionExtension.ThrowIfNullOrEmpty(parameterPolicy);
...
//        {
//            IReadOnlyDictionary<string, TValue> CombineDictionaries<TValue>(
...
//                        throw new InvalidOperationException(Resources.FormatMapGroup_RepeatedDictionaryEntry(rawText1, dictionaryName, key));
//                    }
//                }
//                return combinedDictionary;
//            }

//             Action<RoutePatternParameterPart> CheckDuplicateParameters(int parameterCount, string rawText1)
//            {
...
//                        throw new RoutePatternException(rawText1, errorText);
//                    }
//                };
//            }
