...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public sealed partial class CustomValidationAttribute : ValidationAttribute
    {
        ...
        //private Func<string> _malformedErrorMessage;
#if !SILVERLIGHT
        ...
        public CustomValidationAttribute(Type validatorType, string method)
            : base(() => "CustomValidationAttribute_ValidationError")
        {
        ...
        private string ValidateValidatorTypeParameter()
        {
            ...
            //{
            //    return  "CustomValidationAttribute_Type_Must_Be_Public";
            //}
        ...
        {
            string errorMessage = CheckAttributeWellFormed();//_malformedErrorMessage();
