...
namespace System.Threading.Tasks
{
    ...
    public static partial class TaskToAsyncResult
    {
        ...
        public static Task Unwrap(IAsyncResult asyncResult)
        {
            ...
            if (!((asyncResult as TaskAsyncResult)?._task is Task task))
            {
        ...
        public static Task<TResult> Unwrap<TResult>(IAsyncResult asyncResult)
        {
            ...
            if (!((asyncResult as TaskAsyncResult)?._task is Task<TResult> task))
            {
                throw new ArgumentException(null, nameof(asyncResult));
            }
        ...
        /// </remarks>
        private sealed partial class TaskAsyncResult : IAsyncResult
        {
