...
namespace System.Net.Http.Headers
{
    internal static partial class KnownHeaders
    {
        ...
        public static readonly KnownHeader AccessControlAllowCredentials = new KnownHeader("Access-Control-Allow-Credentials", HttpHeaderType.Response, parser: null, knownValues: new string[] { "true" }/*, http3StaticTableIndex: H3StaticTable.AccessControlAllowCredentials*/);
        public static readonly KnownHeader AccessControlAllowHeaders = new KnownHeader("Access-Control-Allow-Headers", HttpHeaderType.Response, parser: null, knownValues: new string[] { "*" }/*, http3StaticTableIndex: H3StaticTable.AccessControlAllowHeadersCacheControl*/);
        public static readonly KnownHeader AccessControlAllowMethods = new KnownHeader("Access-Control-Allow-Methods", HttpHeaderType.Response, parser: null, knownValues: new string[] { "*" }/*, http3StaticTableIndex: H3StaticTable.AccessControlAllowMethodsGet*/);
        public static readonly KnownHeader AccessControlAllowOrigin = new KnownHeader("Access-Control-Allow-Origin", HttpHeaderType.Response, parser: null, knownValues: new string[] { "*", "null" }/*, H2StaticTable.AccessControlAllowOrigin, H3StaticTable.AccessControlAllowOriginAny*/);
        public static readonly KnownHeader AccessControlExposeHeaders = new KnownHeader("Access-Control-Expose-Headers", HttpHeaderType.Response, parser: null, knownValues: new string[] { "*" }/*, H3StaticTable.AccessControlExposeHeadersContentLength*/);
        ...
        private readonly partial struct StringAccessor : IHeaderNameAccessor
        {
        ...
        private readonly /*unsafe*/ partial struct BytePtrAccessor : IHeaderNameAccessor
        {
