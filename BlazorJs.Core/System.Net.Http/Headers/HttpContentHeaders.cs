...
namespace System.Net.Http.Headers
{
    public sealed partial class HttpContentHeaders : HttpHeaders
    {
        ...
        public ICollection<string> Allow =>
            _allow = _allow ?? new HttpHeaderValueCollection<string>(KnownHeaders.Allow.Descriptor, this);
        ...
        public ICollection<string> ContentEncoding =>
            _contentEncoding = _contentEncoding ?? new HttpHeaderValueCollection<string>(KnownHeaders.ContentEncoding.Descriptor, this);

        public ICollection<string> ContentLanguage =>
            _contentLanguage=_contentLanguage ?? new HttpHeaderValueCollection<string>(KnownHeaders.ContentLanguage.Descriptor, this);
