...
{
    internal sealed partial class UnvalidatedObjectCollection<T> : ObjectCollection<T> where T : class
    {
    ...
    internal abstract partial class ObjectCollection<T> : ICollection<T> where T : class
    {
