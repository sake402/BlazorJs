...
namespace System.Net.Http.Headers
{
    public sealed partial class HttpRequestHeaders : HttpHeaders
    {
        ...
        private T GetSpecializedCollection<T>(int slot, Func<HttpRequestHeaders, T> creationFunc)
        {
            ...
            _specialCollectionsSlots = _specialCollectionsSlots ?? new object[NumCollectionsSlots];
            return (T)(_specialCollectionsSlots[slot] = _specialCollectionsSlots[slot] ?? creationFunc(this));
        }
        ...
        public HttpHeaderValueCollection<NameValueWithParametersHeaderValue> Expect =>
            GetSpecializedCollection(ExpectSlot, thisRef => new HttpHeaderValueCollection<NameValueWithParametersHeaderValue>(KnownHeaders.Expect.Descriptor, thisRef));
