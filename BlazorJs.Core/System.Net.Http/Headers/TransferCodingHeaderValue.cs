...
{
    public partial class TransferCodingHeaderValue : ICloneable
    {
        ...
        public ICollection<NameValueHeaderValue> Parameters => _parameters = _parameters = _parameters ?? new UnvalidatedObjectCollection<NameValueHeaderValue>();
