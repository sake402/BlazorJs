...
{
    public partial class ContentRangeHeaderValue : ICloneable
    {
        ...
        public long? From => HasRange ? _from : (long?)null;

        public long? To => HasRange ? _to : (long?)null;

        public long? Length => HasLength ? _length : (long?)null;
