...
{
    public partial class AuthenticationHeaderValue : ICloneable
    {
        ...
        internal static int GetAuthenticationLength(string input, int startIndex, out object parsedValue)
        {
            ...
            string scheme = targetScheme != null && string.Compare(input, startIndex, targetScheme, 0, schemeLength) == 0 ?
                targetScheme :
                input.Substring(startIndex, schemeLength);
