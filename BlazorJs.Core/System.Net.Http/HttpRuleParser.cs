...
namespace System.Net.Http
{
    internal static partial class HttpRuleParser
    {
        ...
        private static readonly string s_tokenChars = "!#$%&'*+-.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ^_`abcdefghijklmnopqrstuvwxyz|~";

        private static readonly string s_tokenBytes = "!#$%&'*+-.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ^_`abcdefghijklmnopqrstuvwxyz|~";

        private static readonly string s_hostDelimiterChars = "/ \t\r,";
        ...
        internal static Encoding DefaultHttpEncoding => Encoding.Default;//.Latin1;
