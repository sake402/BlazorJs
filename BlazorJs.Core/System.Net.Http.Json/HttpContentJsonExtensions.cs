...
namespace System.Net.Http.Json
{
    public static partial class HttpContentJsonExtensions
    {
        ...
        internal static Task<Stream> GetContentStreamAsync(HttpContent content, CancellationToken cancellationToken)
        {
        ...
        private static async Task<Stream> GetTranscodingStreamAsync(Task<Stream> task, Encoding sourceEncoding)
        {
