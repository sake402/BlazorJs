...
{
    public partial class NavLink : ComponentBase
    {
        ...
        protected internal override void OnParametersSet()
        {
            ...
            if (this.TryGetValue("href", out var obj))
            {
            ...
            _class = (string)null;
            if (this.TryGetValue("class", out obj))
            {
        ...
        /// <inheritdoc/>
        //protected override void BuildRenderTree(IUIFrame builder)
        //{
