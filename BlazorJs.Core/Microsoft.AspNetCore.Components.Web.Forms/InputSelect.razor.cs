...
namespace Microsoft.AspNetCore.Components.Forms
{
    ...
    public partial class InputSelect<TValue> : InputBase<TValue>
    {
        ...
        //        builder.AddAttribute(6, "onchange", EventCallback.Factory.CreateBinder<string[]>(this, (Action<string[]>)SetCurrentValueAsStringArray, default));
        ...
        protected override string FormatValueAsString(TValue value)
        {
            ...
            {
                return !(value == null) && (bool)(object)value ? "true" : "false";
            }
