...
namespace Microsoft.AspNetCore.Components.Forms
{
    ...
    /// </summary>
    public abstract partial class InputBase<TValue> : ComponentBase
    {
        ...
        protected string NameAttributeValue
        {
            get
            {
                if (this.TryGetValue("name", out var nameAttributeValue))
                {
                ...
                {
                    if (_formattedValueExpression is null && !(ValueExpression is null))
                    {
        ...
        protected internal override void OnParametersSet()
        {
            ...
            if (!_hasInitializedParameters)
            {
                ...
                else
                {
                    ...
                    _shouldGenerateFieldNames = false;//!OperatingSystem.IsBrowser();
                }
        ...
        private void UpdateAdditionalValidationAttributes()
        {
            ...
            var hasAriaInvalidAttribute = this.ContainsKey("aria-invalid");
