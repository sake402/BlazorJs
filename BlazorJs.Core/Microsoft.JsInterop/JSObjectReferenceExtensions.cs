...
namespace Microsoft.JSInterop
{
    ...
    public static class JSObjectReferenceExtensions
    {
        ...
        public static async Task InvokeVoidAsync(this IJSObjectReference jsObjectReference, string identifier, params object[] args)
        {
        ...
        public static Task<TValue> InvokeAsync<TValue>(this IJSObjectReference jsObjectReference, string identifier, params object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
        ...
        /// <param name="args">JSON-serializable arguments.</param>
        /// <returns>An instance of <typeparamref name="TValue"/> obtained by JSON-deserializing the return value.</returns>
        public static Task<TValue> InvokeAsync<TValue>(this IJSObjectReference jsObjectReference, string identifier, CancellationToken cancellationToken, params object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
        ...
        /// <param name="args">JSON-serializable arguments.</param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous invocation operation.</returns>
        public static async Task InvokeVoidAsync(this IJSObjectReference jsObjectReference, string identifier, CancellationToken cancellationToken, params object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
        ...
        /// <param name="args">JSON-serializable arguments.</param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous invocation operation.</returns>
        public static async Task<TValue> InvokeAsync<TValue>(this IJSObjectReference jsObjectReference, string identifier, TimeSpan timeout, params object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
        ...
        /// <param name="args">JSON-serializable arguments.</param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous invocation operation.</returns>
        public static async Task InvokeVoidAsync(this IJSObjectReference jsObjectReference, string identifier, TimeSpan timeout, params object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
        ...
        public static Task<IJSObjectReference> InvokeNewAsync(this IJSObjectReference jsObjectReference, string identifier, params object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
        ...
        /// <param name="args">JSON-serializable arguments.</param>
        /// <returns>An <see cref="IJSObjectReference"/> instance that represents the created JS object.</returns>
        public static Task<IJSObjectReference> InvokeNewAsync(this IJSObjectReference jsObjectReference, string identifier, CancellationToken cancellationToken, object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
        ...
        /// <param name="args">JSON-serializable arguments.</param>
        /// <returns>An <see cref="IJSObjectReference"/> instance that represents the created JS object.</returns>
        public static Task<IJSObjectReference> InvokeNewAsync(this IJSObjectReference jsObjectReference, string identifier, TimeSpan timeout, object[] args)
        {
            ArgumentNullExceptionExtension.ThrowIfNull(jsObjectReference);
