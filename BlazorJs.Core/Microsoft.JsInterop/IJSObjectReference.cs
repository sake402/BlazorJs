...
namespace Microsoft.JSInterop
{
    ...
    /// </summary>
    public interface IJSObjectReference : IDisposable// IAsyncDisposable
    {
        /// <summary>
        ...
        Task SetValueAsync<TValue>(string identifier, TValue value);
        ...
        /// </param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous invocation operation.</returns>
        Task SetValueAsync<TValue>(string identifier, TValue value, CancellationToken cancellationToken);
    }
}