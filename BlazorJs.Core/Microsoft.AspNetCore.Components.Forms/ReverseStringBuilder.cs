...
namespace Microsoft.AspNetCore.Components.Forms
{
    internal ref partial struct ReverseStringBuilder
    {
        ...
        public ReverseStringBuilder(Span<char> initialBuffer)
        {
            ...
            _nextEndIndex = _currentBuffer.Length;
            //_fallbackSequenceSegment = null;
        }

        public bool Empty => _nextEndIndex == _currentBuffer.Length;

        public void InsertFront(ReadOnlySpan<char> span)
        {
            ...
            if (startIndex >= 0)
            {
                ...
                span.CopyTo(_currentBuffer[new System.Range(startIndex, -1)]);
            ...
            //    _currentBuffer[new System.Range(_nextEndIndex, -1)].CopyTo(newBuffer.AsSpan(newEndIndex));
            ...
            //    var remainingLength = -startIndex;
            //    span[new System.Range(remainingLength, -1)].CopyTo(_currentBuffer);
            //    span = span[new System.Range(0, remainingLength)];
        ...
        public void InsertFront<T>(T value)// where T : ISpanFormattable
        {
            ...
            Span<char> result = new Span<char>(11);// stackalloc char[11];
        ...
        public override string ToString()
            =>
                 ...
                 _currentBuffer[new System.Range(_nextEndIndex, -1)].AsString()
        ...
        //private sealed partial class SequenceSegment : ReadOnlySequenceSegment<char>, IDisposable
        //{
