...
namespace Microsoft.AspNetCore.Components
{
    ...
    public static partial class BindConverter
    {
        ...
        /// </param>
        /// <returns>The formatted value.</returns>
        public static string FormatValue(DateTime value, CultureInfo culture = null) => FormatDateTimeValueCore(value, null, culture);
        ...
        /// </param>
        /// <returns>The formatted value.</returns>
        public static string FormatValue(DateTime? value, CultureInfo culture = null) => FormatNullableDateTimeValueCore(value, null, culture);
        ...
        /// </param>
        /// <returns>The formatted value.</returns>
        public static string FormatValue(DateTimeOffset value, CultureInfo culture = null) => FormatDateTimeOffsetValueCore(value, null, culture);
        ...
        /// </param>
        /// <returns>The formatted value.</returns>
        public static string FormatValue(DateTimeOffset? value, CultureInfo culture = null) => FormatNullableDateTimeOffsetValueCore(value, null, culture);
        ...
        //public static string FormatValue(DateOnly value, CultureInfo culture = null) => FormatDateOnlyValueCore(value, null, culture);
        ...
        ///// <returns>The formatted value.</returns>
        //[SuppressMessage("ApiDesign", "RS0026:Do not add multiple public overloads with optional parameters", Justification = "Required to maintain compatibility")]
        //public static string FormatValue(DateOnly value, CultureInfo culture = null) => FormatNullableDateOnlyValueCore(value, null, culture);
        ...
        ///// <returns>The formatted value.</returns>
        //[SuppressMessage("ApiDesign", "RS0026:Do not add multiple public overloads with optional parameters", Justification = "Required to maintain compatibility")]
        //public static string FormatValue(TimeOnly value, CultureInfo culture = null) => FormatTimeOnlyValueCore(value, null, culture);
        ...
        ///// <returns>The formatted value.</returns>
        //[SuppressMessage("ApiDesign", "RS0026:Do not add multiple public overloads with optional parameters", Justification = "Required to maintain compatibility")]
        //public static string FormatValue(TimeOnly value, CultureInfo culture = null) => FormatNullableTimeOnlyValueCore(value, null, culture);
        ...
        {
            return ConvertToDateTimeCore(obj, culture, null, out value);
        }
        ...
        private static bool ConvertToDateTimeCore(object obj, CultureInfo culture, string format, out DateTime value)
        {
            ...
            if (format != null && DateTime.TryParseExact(text, format/*, culture ?? CultureInfo.CurrentCulture*//*, DateTimeStyles.None*/, null, out var converted))
            {
                value = converted;
                return true;
            }
        ...
        {
            return ConvertToNullableDateTimeCore(obj, culture, null, out value);
        }
        ...
        {
            return ConvertToDateTimeOffsetCore(obj, culture, null, out value);
        }
        ...
        private static bool ConvertToDateTimeOffsetCore(object obj, CultureInfo culture, string format, out DateTimeOffset value)
        {
            ...
            //}
            //else 
            if (format == null && DateTimeOffset.TryParse(text/*, culture ?? CultureInfo.CurrentCulture*//*, DateTimeStyles.None*/, out var converted))
            {
                value = converted;
                return true;
            }
        ...
        {
            return ConvertToNullableDateTimeOffsetCore(obj, culture, null, out value);
        }
        ...
        private static bool ConvertToNullableDateTimeOffsetCore(object obj, CultureInfo culture, string format, out DateTimeOffset? value)
        {
            ...
            //if (format != null && DateTimeOffset.TryParseExact(text, format/*, culture ?? CultureInfo.CurrentCulture*//*, DateTimeStyles.None*/, null, out var converted))
            //{
            //    value = converted;
            //    return true;
            //}
        ...
        //{
        //    return ConvertToDateOnlyCore(obj, culture, null, out value);
        //}
        ...
        //{
        //    return ConvertToNullableDateOnlyCore(obj, culture, null, out value);
        //}
        ...
        //{
        //    return ConvertToTimeOnlyCore(obj, culture, null, out value);
        //}
        ...
        //{
        //    return ConvertToNullableTimeOnlyCore(obj, culture, null, out value);
        //}
        ...
        private static partial class FormatterDelegateCache
        {
            ...
            public static BindFormatter<T> Get<T>()
            {
                if (!_cache.TryGetValue(typeof(T), out var formatter))
                {
                    ...
                    //}
                    else if (typeof(T).IsEnum || Nullable.GetUnderlyingType(typeof(T)) is Type innerType && innerType.IsEnum)
                    {
                        formatter = (BindFormatter<T>)FormatEnumValueCore<T>;
                    }
                    else if (typeof(T).IsArray)
                    {
                        var method = _makeArrayFormatter = _makeArrayFormatter ?? typeof(FormatterDelegateCache).GetMethod(nameof(MakeArrayFormatter), BindingFlags.NonPublic | BindingFlags.Static);
            ...
            static string FormatArrayValue<T>(T[] value, CultureInfo culture)
            {
            ...
            private static BindFormatter<T[]> MakeArrayFormatter<T>()
            {
                var elementFormatter = Get<T>();
            ...
            private static BindFormatter<T> MakeTypeConverterFormatter<T>()
            {
                ...
                {
                    throw new InvalidOperationException($"No converter is defined for {typeof(T).FullName}");
        ...
        internal static partial class ParserDelegateCache
        {
            ...
            public static BindParser<T> Get<T>()
            {
                if (!_cache.TryGetValue(typeof(T), out var parser))
                {
                    ...
                    else if (typeof(T).IsEnum)
                    {
                        ...
                        var method = _convertToEnum = _convertToEnum ?? typeof(BindConverter).GetMethod(nameof(ConvertToEnum), BindingFlags.NonPublic | BindingFlags.Static);
                    ...
                    {
                        // We have to deal invoke this dynamically to work around the type constraint on Enum.TryParse.
                        var method = _convertToNullableEnum = _convertToNullableEnum ?? typeof(BindConverter).GetMethod(nameof(ConvertToNullableEnum), BindingFlags.NonPublic | BindingFlags.Static);
                        parser = method.MakeGenericMethod(innerType).CreateDelegate(typeof(BindParser<T>), target: null);
                    }
                    else if (typeof(T).IsArray)
                    {
                        var method = _makeArrayTypeConverter = _makeArrayTypeConverter ?? typeof(ParserDelegateCache).GetMethod(nameof(MakeArrayTypeConverter), BindingFlags.NonPublic | BindingFlags.Static);
                        var elementType = typeof(T).GetElementType();
            ...
            private static BindParser<T> MakeTypeConverterConverter<T>()
            {
                ...
                //{
                throw new InvalidOperationException($"No converter for {typeof(T).FullName}");
                //$"The type '{typeof(T).FullName}' does not have an associated {typeof(TypeConverter).Name} that supports " +
