...
namespace Microsoft.AspNetCore.Components.Sections
{
    ...
    /// </summary>
    public sealed class SectionOutlet : IComponent
    {
        private static readonly RenderFragment _emptyRenderFragment = (_, __) => { };
        ...
        private void BuildRenderTree(IUIFrame frame, object key)
        {
        ...
        //internal sealed class SectionOutletContentRenderer : ComponentBase, IComponent
        //{
